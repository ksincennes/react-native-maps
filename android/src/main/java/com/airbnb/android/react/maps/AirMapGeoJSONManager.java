...
public class AirMapGeoJSONManager extends ViewGroupManager<AirMapGeoJSON> {
	...
	public void setAnchor(AirMapGeoJSON view, ReadableMap map) {
		// should default to (0.5, 1) (bottom middle)
		double x = map != null && map.hasKey("U") ? map.getDouble("U") : 0.5;
		double y = map != null && map.hasKey("V") ? map.getDouble("V") : 1.0;
		view.setAnchor((float) x, (float) y);
	}
	...
	public void setDraggable(AirMapGeoJSON view, boolean draggable) {
		view.setDraggable(draggable);package com.airbnb.android.react.maps;
...
public class AirMapGeoJSONManager extends ViewGroupManager<AirMapGeoJSON> {
	...
	@ReactProp(name = "icon")
	public void setIcon(AirMapGeoJSON view, @Nullable String icon) {
		view.setIcon(icon);
	}

	@Override
	public void addView(AirMapGeoJSON parent, View child, int index) {
	...
	@ReactProp(name = "icon")
	public void setIcon(AirMapGeoJSON view, @Nullable String icon) {
		Log.e("IMAGESET", "Setting icon to: "+ icon);
		view.setIcon(icon);
	}
